...
//Exercise#1
{
  console.log("                                                      ");
  console.log(
    "\x1b[32mExercise #1 Write a program that calculates the area of a rectangle.\x1b[0m"
  );
  console.log("                                                      ");
  var length: number = 6;
  var width: number = 7;
...
{
  console.log(
    "\x1b[32mExercise #2 Write a program that takes input and calculates the volume of a cube.\x1b[0m"
  );
  console.log("                                                      ");
...
{
  console.log(
    "\x1b[32mExercise #3 Write a program that checks if a given number is positive, negative, or zero.\x1b[0m"
  );
  console.log("                                                      ");

  var givenNumb: number = 5;
...
//Exercise#4
{
  console.log("                                                      ");
  console.log(
    "\x1b[32mExercise #4 Write a program that checks if a given number is even or odd.      \x1b[0m"
  );
  console.log("                                                      ");

  var EvenOrOdd: number = 5;
  if (EvenOrOdd % 2 == 0) {
...
{
  console.log(
    "\x1b[32mExercise #5 Write a program that determines if a person is eligible to vote based on their age.\x1b[0m"
  );
  console.log("                                                      ");
...
{
  console.log(
    "\x1b[32mExercise #6 Write a program that calculates the result of a mathematical expression.	((10 + 5) * 3 - 2) / (4 % 3)  - 7)\x1b[0m"
  );
  console.log("                                                      ");
