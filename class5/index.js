...
{
    console.log("                                                      ");
    console.log("\x1b[32mExercise #1 Create a function that takes an array, an index, and a value as parameters.\x1b[0m");
    console.log("\x1b[32m             Inside the function, use the splice method to insert the value at the specified index in the array. Return the modified array.\x1b[0m");
    console.log("                                                      ");
    let arr = [1, 2, 3, 4, 5, 6, 7, 8, 9];
    function callN(arr, index, value) {
...
//Exercise #3
{
    console.log("\x1b[32mExercise 3:  - Write a program that uses a while loop to print the first 25 integers.\x1b[0m");
    console.log("                                                      ");
...
{
    console.log("                                                      ");
    console.log("\x1b[32mExercise 4:  - Write a program that uses a while loop to print the first 10 even numbers.\x1b[0m");
    console.log("                                                      ");
...
//Exercise #5
{
    console.log("\x1b[32mExercise 5: - Create a function that takes a positive integer as parameter. and uses a while loop to calculate and return the factorial of that number.\x1b[0m");
    console.log("                                                      ");
...
//Exercise #6
{
    console.log("\x1b[32mExercise 6: - Write a program having an array of numbers. if the number is negative it should remove the negative number from the array.\x1b[0m");
    console.log("                                                      ");
...
//Exercise #7
{
    console.log("\x1b[32mExercise 7: - Create a function that takes an array of numbers as parameter. Use a while loop to calculate and return the sum of all the numbers in the array.\x1b[0m");
    console.log("                                                      ");
...
//Exercise #8
{
    console.log("\x1b[32mExercise 8: - Implement a program that takes a list of temperatures in Celsius as input from the user.Convert each temperature to Fahrenheit using the formula F = (C * 9/5) + 32 and store the converted temperatures in an array.Use a while loop to perform the conversion for each temperature.\x1b[0m");
    console.log("                                                      ");
    let listOfTempInC = [6, 2, 8, 4, 45, 2562, 24532, 4355, 5232, 7];
    function tempConverterInF(list) {
        let i = 0;
        let converted = [];
        while (i < list.length) {
